...
select sayi from kitap where yazarno=33;

-- SORU03: yazar no su 4 ile 9 arasinda olan yazar isimleriniz yazdirin 
select ad,soyad from yazar where yazarno between 4 and 9; 

-- soru charles dickens ile turgut aytmatov arasindaki yazarlari listeleyin
select ad,soyad from yazar where ad between 'Charles Dickens' and 'Turgut Aytmatov';

-- sayfa sayisi 200 den buyuk kitap ismi 'beyaz dis' olan kitabin ismi puanini getir
select puan,sayfasayisi,ad from kitap where sayfasayisi>200 and ad='Beyaz Diş';
...
select ad from yazar where ad like 'A%';
